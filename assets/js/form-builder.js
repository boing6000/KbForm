...
fbUtils.fieldRender = function (fieldData, opts) {
    ...
    if(preview){
        //fieldData['className'] += ' no-focus';
    }

   /* var data = {
        aa: 'KbForm.getInputHtml',
        securityToken: ip.securityToken,
        input: JSON.stringify(fieldData)
    };
    return $.ajax({
        type: 'POST',
        url: ip.baseUrl,
...
function formBuilderHelpersFn(opts, formBuilder) {
    ...
    _helpers.updatePreview = function (field) {
        ...
        /*utils.fieldRender(previewData, opts, true).done(function (e) {
            $prevHolder.html(e);
        });*/
    ...
    var FormBuilder = function FormBuilder(options, element) {
        ...
        var defaults = {
            ...
            messages: {
                ...
                button: 'Botão',
                cannotBeEmpty: 'Este campo é obrigatório.',
                ...
                editorTitle: 'Elemntos do Formulário',
                editXML: 'Editar XML',
                enableOther: 'Ativar &quot;Outro&quot;',
                enableOtherMsg: 'Permitir que os usuários adicionem novas opções.',
                fieldDeleteWarning: true,
                fieldVars: 'Field Variables',
                fieldNonEditable: 'Este cmapo não pode ser editado.',
                fieldRemoveWarning: 'Tem certeza que deseja remover este campo?',
                fileUpload: 'Enviar Arquivo',
                formUpdated: 'Form Updated',
                getStarted: 'Arraste e solte os campos desejados do menu à esquerda.',
                header: 'Cabeçalho',
                hide: 'Editar',
                hidden: 'Campo Oculto',
                label: 'Legenda',
                labelEmpty: 'Legenda do campo não pode estar vazio',
                ...
                option: 'Opção',
                optional: 'Opcional',
                optionLabelPlaceholder: 'Legenda',
                ...
                placeholders: {
                    ...
                    placeholder: '',
                    className: 'Espaço separado classes',
                    password: 'Entre sua à senha'
                },
                preview: 'Preview',
                radioGroup: 'Grupo Radio',
                radio: 'Radio',
        ...
        utils.forEach(frmbFields, function (i) {
            var $field = $('<li/>', {
                'class': 'frm-' + frmbFields[i].attrs.className,
        ...
        var prepFieldVars = function prepFieldVars($field) {
            ...
            if (isNew && utils.inArray(field.type, ['text', 'number', 'select', 'textarea'])) {
        ...
        var advFields = function advFields(values) {
            ...
            if (values.type === 'checkbox-group' || values.type === 'radio-group') {
                advFields.push(boolAttribute('other', values, {
            ...
            if (values.type === 'select') {
                advFields.push(boolAttribute('multiple', values, {
                    first: ' ',
        ...
        // Copy field
        $sortableFields.on('click touchstart', '.frm-copy', function (e) {
            e.preventDefault();
